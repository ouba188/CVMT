...
class DetDataPreprocessor_CVMT(ImgDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        data1_input = data['inputs'][0]
        data2_input = data['inputs'][1]
        ...
        data1 = super().forward(data=data1, training=training)
        data2 = super().forward(data=data2, training=training)

        inputs1, inputs2, data_samples = data1['inputs'], data2['inputs'], data['data_samples']
        ...
        if training and self.batch_augments is not None:
            for batch_aug in self.batch_augments:
                inputs1, data_samples_out = batch_aug(inputs1, data_samples)
                inputs2, noa = batch_aug(inputs2, data_samples)
