...
class DETRHead(BaseModule):
    ...
    def loss_by_feat_single(self, cls_scores: Tensor, bbox_preds: Tensor,
        ...
        if isinstance(self.loss_cls, QualityFocalLoss):
            ...
            pos_decode_bbox_pred= pos_decode_bbox_pred.to(d)
            pos_decode_bbox_targets=pos_decode_bbox_targets.to(d)
            pos_inds = pos_inds.to(d)
            scores = scores.to(d)
...
#########
        ...
        pos_gt_bboxes = pos_gt_bboxes.to(device)
