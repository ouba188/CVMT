...
class LoadDataFromFile_CVMT(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        #It may need to be adjusted according to the organization form of your dataset
        data_root = re.split(r'/(train|val)/', results["img_path"], maxsplit=1)[0]
        filename1 = data_root + '/'+results['img_path_amp']
        filename2 = data_root + '/'+ results['img_path_phase']
