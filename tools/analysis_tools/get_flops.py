...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',default='/media/sata/wpc/mmdetection_dbdino/projects/CO-DETR/configs/codino/co_dino_5scale_r50_lsj_8xb2_1x_coco.py')
    parser.add_argument(
        '--num-images',
        type=int,
        default=100,
